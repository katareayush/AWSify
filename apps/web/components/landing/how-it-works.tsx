...
function StepRow({ n, title, body, code, Icon }: StepRowProps) {
  return (
    <div className="grid grid-cols-1 gap-0 bg-[#070708] lg:grid-cols-[180px_1fr_minmax(0,420px)]">
      ...
      <div className="border-b border-white/[0.06] p-7 lg:border-b-0 lg:border-r">
        <h3 className="text-[22px] font-medium tracking-tight text-white">{title}</h3>
      ...
      <div className="relative bg-black/40 p-5">
        ...
        <pre className="mt-3 whitespace-pre-wrap font-mono text-[12px] leading-[1.7] text-white/75">
          {code}
