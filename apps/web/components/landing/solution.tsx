...
export function Solution() {
  return (
    <Section eyebrow="The solution" title="A control plane between your repo and AWS.">
      <p className="mx-auto mt-5 max-w-2xl text-center text-[15px] leading-[1.55] text-white/55 sm:mt-6 sm:text-[17px]">
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border border-white/[0.08] bg-gradient-to-b from-white/[0.04] to-white/[0.01] p-5 transition-all hover:border-white/[0.14] sm:rounded-2xl sm:p-7">
      ...
      <div className="relative">
        ...
        <h3 className="mt-5 text-[18px] font-medium tracking-tight text-white sm:mt-6 sm:text-[19px]">{title}</h3>
